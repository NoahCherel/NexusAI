            ...
            <div className="flex flex-col gap-1.5 flex-1 min-w-0">
                ...
                {isEditing ? (
                    ...
                    <motion.div
                        ...
                        initial="rest"
                        whileHover="hover"
                        className={`text-sm sm:text-base leading-relaxed whitespace-pre-wrap break-words min-h-[1.5em] ${isUser ? 'text-foreground/70 font-bold' : 'text-foreground/90 font-medium'
                            }`}
                    >
                        {!content && !isUser ? (
