...
export const DEFAULT_MODELS: CustomModel[] = [
    ...
    { id: 'llama-3.3-70b', name: 'Llama 3.3 70B (Free)', modelId: 'meta-llama/llama-3.3-70b-instruct:free', provider: 'openrouter', isFree: true },
    { id: 'deepseek-r1', name: 'DeepSeek R1 (Free)', modelId: 'deepseek/deepseek-r1:free', provider: 'openrouter', isFree: true },
    { id: 'deepseek-r1-0528', name: 'DeepSeek R1 0528 (Free)', modelId: 'deepseek/deepseek-r1-0528:free', provider: 'openrouter', isFree: true },
    { id: 'deepseek-r1-distill', name: 'DeepSeek R1 Distill 70B (Free)', modelId: 'deepseek/deepseek-r1-distill-llama-70b:free', provider: 'openrouter', isFree: true },
    { id: 'qwen-2.5-72b', name: 'Qwen 2.5 72B (Free)', modelId: 'qwen/qwen-2.5-72b-instruct:free', provider: 'openrouter', isFree: true },
    { id: 'qwen-coder', name: 'Qwen 3 Coder (Free)', modelId: 'qwen/qwen3-coder:free', provider: 'openrouter', isFree: true },
    { id: 'mistral-large', name: 'Mistral Large 2411 (Free)', modelId: 'mistralai/mistral-large-2411:free', provider: 'openrouter', isFree: true },
    { id: 'nvidia-nemotron-70b', name: 'Nvidia Nemotron 70B (Free)', modelId: 'nvidia/llama-3.1-nemotron-70b-instruct:free', provider: 'openrouter', isFree: true },
    { id: 'dolphin-24b', name: 'Dolphin Mistral 24B (Free)', modelId: 'cognitivecomputations/dolphin-mistral-24b-venice-edition:free', provider: 'openrouter', isFree: true },
    { id: 'gemma-3-27b', name: 'Gemma 3 27B (Free)', modelId: 'google/gemma-3-27b-it:free', provider: 'openrouter', isFree: true },
